...
def equipment_equivalences(equipment_type: str, equipment: 'Equipment') -> bool:
    ...
    if equipment_type == "ARMOR" and equipment.equipment_type in constants.ARMOR_TYPES:
        ...
        return True
    if equipment_type == "HEADBAND" and equipment.equipment_type in constants.HEADBAND_TYPES:
        return True
    elif equipment_type == "TOOL" and equipment.equipment_type in constants.TOOL_TYPES:
        return True
    return False
